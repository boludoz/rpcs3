...
{
	sys_log.notice("Loading ISO '%s' (path-less source)", display_name);

	fs::set_virtual_device("iso_overlay_fs_dev", stx::make_shared<iso_device>(std::move(opener), display_name));
